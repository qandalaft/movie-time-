alert ("welcome to movie time site ")
 ...
 var age = prompt()
 if(age>=18){
   alert("welcome agin "+name+" are you He or she")
  }
 else  {
...
var ask = prompt("hello agin "+name+" Enter the most fantastic character in Hanter X Hanter Anime you can Choose from the following  :-  A)gon , B)Killua , C)Kurapika   ")
 if("Killua" == ask){
  ...
  alert("of course Killua is the most fantastic character in Hanter X Hanter Anime ")
}else{ 
while("Killua" != ask){
  ask = prompt("try one more time "+name)
 if("Killua" == ask){
